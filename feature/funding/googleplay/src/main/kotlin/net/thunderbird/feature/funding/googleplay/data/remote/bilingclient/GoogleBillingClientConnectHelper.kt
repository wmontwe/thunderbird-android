    ...
    return connectMutex.withLock {
        ...
        client.startConnection(object : BillingClientStateListener {
            override fun onBillingSetupFinished(billingResult: GoogleBillingResult) {
                // map the billing result to a simple Unit success/failure, then run onConnected only on success
                scope.launch {
            ...
            override fun onBillingServiceDisconnected() {
                // Keep the deferred unsettled until onBillingSetupFinished or handle as needed.
                // Optionally complete with an error if you want immediate failure on disconnect.
            }
        })
